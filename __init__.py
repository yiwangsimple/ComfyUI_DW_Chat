...
NODE_CLASS_MAPPINGS = {**GROQ_CLASS_MAPPINGS, **PALI_CLASS_MAPPINGS, **MOONSHOT_CLASS_MAPPINGS, **SD3_CLASS_MAPPINGS}
NODE_DISPLAY_NAME_MAPPINGS = {**GROQ_DISPLAY_MAPPINGS, **PALI_DISPLAY_MAPPINGS, **MOONSHOT_DISPLAY_MAPPINGS, **SD3_DISPLAY_MAPPINGS}
