...
class GroqChatNode:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "model": (["deepseek-r1-distill-llama-70b", "gemma-7b-it", "gemma2-9b-it", "mixtral-8x7b-32768", "llama3-8b-8192", "llama3-70b-8192","llama3-groq-8b-8192-tool-use-preview","llama3-groq-70b-8192-tool-use-preview", "llama-3.1-8b-instant", "llama-3.1-70b-versatile", "llama-3.2-1b-preview", "llama-3.2-3b-preview", "llama-3.2-7b-preview", "llama-3.2-11b-vision-preview", "llama-3.2-90b-vision-preview", "llava-v1.5-7b-4096-preview", "llama-guard-3-8b"],),
